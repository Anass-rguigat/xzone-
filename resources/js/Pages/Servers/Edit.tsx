        ...
        <Layout>
            <div className="mx-auto max-w-full p-4 sm:px-6 lg:px-8 space-y-6 bg-white">
                <div className="space-y-1">
                    <h1 className="text-lg font-semibold text-gray-900">Modifier le Serveur</h1>
                    <p className="text-xs text-gray-600">Mettez à jour les spécifications techniques du serveur</p>
                </div>
                            ...
                            {componentGroups.map(({ label, name, options }) => (
                                <div key={name}>
                                    ...
                                    {errors[name as keyof typeof errors] && (
                                        <p className="text-red-600 text-xs mt-1">{errors[name as keyof typeof errors]}</p>
                                    )}
                                </div>
                            ))}
                        </div>

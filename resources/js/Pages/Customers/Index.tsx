                    ...
                    <div className="rounded-lg border border-gray-200 overflow-hidden shadow-sm">
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((customer) => (
                                        <tr key={customer.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-4 py-2 text-sm text-gray-600">{customer.city}</td>
                                            <td className="px-4 py-2 text-sm text-gray-600">{customer.country}</td>
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center p-3 border-t border-gray-200 text-xs">
                            <div className="mb-2 sm:mb-0 text-gray-600">
                                {filteredCustomers.length} résultat{filteredCustomers.length > 1 && 's'} • Page {currentPage} sur {totalPages}
                            </div>
...
// Conserver les mêmes icônes SVG que dans votre exemple

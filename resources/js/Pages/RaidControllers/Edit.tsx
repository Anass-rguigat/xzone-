        ...
        <Layout>
            <div className="mx-auto max-w-full p-5 sm:px-6 lg:px-8 space-y-8 bg-white">
                <div className="space-y-2">
                    <h1 className="text-2xl font-semibold text-gray-900">Modifier le contrôleur RAID</h1>
                    <p className="text-gray-600">Mettez à jour les spécifications techniques du contrôleur</p>
                </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    />
                                    {errors.supported_levels && <p className="text-red-600 text-sm mt-1">{errors.supported_levels}</p>}
                                </div>

                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((controller) => (
                                        <tr key={controller.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-4 py-2 text-sm text-gray-900">{controller.name}</td>
                                            <td className="px-4 py-2 text-sm text-gray-600">{controller.brand.name}</td>
                                            <td className="px-4 py-2 text-sm text-purple-600">{controller.model}</td>
                                            <td className="px-4 py-2 text-sm text-gray-700 uppercase">{controller.supported_levels}</td>
                                            <td className="px-4 py-2 text-sm text-blue-600">{controller.price} DH</td>

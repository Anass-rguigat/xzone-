...
export default function Create({ brands, servers }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/raid-controllers', {
            onSuccess: () => toast.success('Contrôleur RAID créé avec succès'),
        ...
        <Layout>
            <div className="mx-auto max-w-full p-4 sm:px-6 lg:px-8 space-y-6 bg-white">
                <div className="space-y-1">
                    <h1 className="text-lg font-semibold text-gray-900">Ajouter un Nouveau Contrôleur RAID</h1>
                    <p className="text-xs text-gray-600">Configurez les spécifications techniques du contrôleur</p>
                </div>
                    ...
                    <div className="space-y-3 w-full">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Entrez le modèle du contrôleur"
                                        className="w-full rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    />
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="Ex: RAID 0, 1, 5, 10"
                                        className="w-full rounded-md border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                    />
                                    {errors.supported_levels && <p className="text-red-600 text-xs mt-1">{errors.supported_levels}</p>}
                                </div>
                        ...
                        <div className="flex justify-end gap-3 pt-4 w-full">
                            ...
                            {can(user, 'Add_Composants') &&
                                ...
                                >
                                    {processing ? 'Enregistrement...' : 'Créer le contrôleur RAID'}
                                </button>
                            }
                        </div>
                    </div>

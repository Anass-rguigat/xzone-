                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((cable) => (
                                        <tr key={cable.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900">{cable.name}</td>
                                            <td className="px-6 py-4 text-sm text-gray-600">{cable.brand.name}</td>
                                            <td className="px-6 py-4 text-sm text-blue-600 font-medium">{cable.price} DH</td>
                                            <td className="px-6 py-4 text-sm text-purple-600 uppercase font-medium">{cable.type}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">{cable.length} m</td>
                                            <td className="px-6 py-4 text-sm text-gray-600 max-w-[200px] truncate">{cable.specifications}</td>

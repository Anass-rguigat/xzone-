...
export default function Create({ brands, servers }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/cable-connectors', {
            onSuccess: () => toast.success('Connecteur créé avec succès'),
        ...
        <Layout>
            <div className="mx-auto max-w-full p-4 sm:px-6 lg:px-8 space-y-6 bg-white">
                <div className="space-y-1">
                    <h1 className="text-lg font-semibold text-gray-900">Ajouter un Nouveau Connecteur de Câble</h1>
                    <p className="text-xs text-gray-600">Configurez les spécifications techniques du connecteur</p>
                </div>
                    ...
                    <div className="space-y-3 w-full">
                        ...
                        <div className="flex justify-end gap-3 pt-4 w-full">
                            ...
                            {can(user, 'Add_Composants') &&
                                ...
                                >
                                    {processing ? 'Enregistrement...' : 'Créer le Connecteur'}
                                </button>
                            }
                        </div>
                    </div>

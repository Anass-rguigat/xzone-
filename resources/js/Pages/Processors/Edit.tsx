        ...
        <Layout>
            <div className="mx-auto max-w-full p-4 sm:px-6 lg:px-8 space-y-6 bg-white">
                <div className="space-y-1">
                    <h1 className="text-lg font-semibold text-gray-900">Modifier le Processeur</h1>
                    <p className="text-xs text-gray-600">Mettez à jour les spécifications techniques du processeur</p>
                </div>

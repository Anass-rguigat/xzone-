                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((hd) => (
                                        <tr key={hd.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-4 py-2 text-sm text-gray-900">{hd.name}</td>
                                            <td className="px-4 py-2 text-sm text-gray-600">{hd.brand.name}</td>
                                            ...
                                            <td className="px-4 py-2 text-sm text-blue-600">{hd.price ? `${hd.price} DH` : '-'}</td>
...
// Keep the same icon components from previous example

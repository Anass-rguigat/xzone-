                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((motherboard) => (
                                        <tr key={motherboard.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900">{motherboard.name}</td>
                                            <td className="px-6 py-4 text-sm text-gray-600">{motherboard.brand.name}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">{motherboard.price} DH</td>

        ...
        <Layout>
            <div className="mx-auto max-w-full p-5 sm:px-6 lg:px-8 space-y-8 bg-white">
                <div className="space-y-2">
                    <h1 className="text-2xl font-semibold text-gray-900">Ajouter une Nouvelle Batterie</h1>
                    <p className="text-gray-600">Configurez les spécifications techniques de la batterie</p>
                </div>

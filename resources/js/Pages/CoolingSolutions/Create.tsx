...
export default function Create({ brands, servers }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/cooling-solutions', {
            onSuccess: () => toast.success('Solution créée avec succès'),
        ...
        <Layout>
            <div className="mx-auto max-w-full p-4 sm:px-6 lg:px-8 space-y-6 bg-white">
                <div className="space-y-1">
                    <h1 className="text-lg font-semibold text-gray-900">Ajouter une Nouvelle Solution de Refroidissement</h1>
                    <p className="text-xs text-gray-600">Configurez les spécifications techniques du système de refroidissement</p>
                </div>
                    ...
                    <div className="space-y-3 w-full">
                        ...
                        <div className="flex justify-end gap-3 pt-4 w-full">
                            ...
                            {can(user, 'Ajouter_Composants') &&
                                ...
                                >
                                    {processing ? 'Enregistrement...' : 'Créer la Solution'}
                                </button>
                            }
                        </div>
                    </div>

                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((solution) => (
                                        <tr key={solution.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-4 py-2 text-sm text-gray-900">{solution.name}</td>
                                            <td className="px-4 py-2 text-sm text-gray-600">{solution.brand.name}</td>
                                            <td className="px-4 py-2 text-sm text-gray-600">{solution.manufacturer}</td>
                                            <td className="px-4 py-2 text-sm text-purple-600 uppercase">{solution.type}</td>
                                            <td className="px-4 py-2 text-sm text-gray-700">{solution.power_rating} W</td>
                                            <td className="px-4 py-2 text-sm text-blue-600">{solution.price} DH</td>

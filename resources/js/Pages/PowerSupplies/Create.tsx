        ...
        <Layout>
            <div className="mx-auto max-w-full p-4 sm:px-6 lg:px-8 space-y-6 bg-white">
                <div className="space-y-1">
                    <h1 className="text-lg font-semibold text-gray-900">Ajouter une Nouvelle Alimentation</h1>
                    <p className="text-xs text-gray-600">Configurez les spécifications techniques de l'alimentation</p>
                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Entrez le nom de l'alimentation"
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center mt-2">
                                        <input
                                            ...
                                            className="w-5 h-5 border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                        />
                                    </div>

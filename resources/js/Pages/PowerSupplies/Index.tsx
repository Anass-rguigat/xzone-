...
export default function Index({ powerSupplies }: Props) {
    ...
    const sortedPowerSupplies = [...filteredPowerSupplies].sort((a, b) => {
        ...
        // Gestion spéciale pour le tri booléen
                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((powerSupply) => (
                                        <tr key={powerSupply.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-sm font-medium text-gray-900">{powerSupply.name}</td>
                                            <td className="px-6 py-4 text-sm text-gray-600">{powerSupply.brand.name}</td>
                                            <td className="px-6 py-4 text-sm text-gray-700">{powerSupply.price ? `${powerSupply.price} €` : '-'}</td>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex gap-3">
                                                    ...
                                                    <Link
                                                        href={`/power-supplies/${powerSupply.id}`}

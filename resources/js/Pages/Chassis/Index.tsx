                                ...
                                <tbody className="divide-y divide-gray-200">
                                    {currentItems.map((chassisItem) => (
                                        <tr key={chassisItem.id} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            <td className="px-4 py-2 text-sm text-gray-900">{chassisItem.name}</td>
                                            <td className="px-4 py-2 text-sm text-gray-600">{chassisItem.brand.name}</td>
                                            <td className="px-4 py-2 text-sm text-blue-600">{chassisItem.price} DH</td>
                                            <td className="px-4 py-2 text-sm text-gray-600 uppercase">{chassisItem.type}</td>
                                            <td className="px-4 py-2 text-sm text-gray-700">{chassisItem.form_factor}</td>
                                            <td className="px-4 py-2 text-sm text-gray-700">{chassisItem.material}</td>
